...
export default function Home() {
    ...
    // Decontructing to make connection dynamic
    // Connected let us know if there's a wallet connected
    // publicKey shows us out phantom key
    ...
    const [reserveListingModalOpen, setReserveListingModalOpen] =
        useState(false);
    const [currentEditListingID, setCurrentEditListingID] = useState(null);
    const [currentReserveListingID, setCurrentReserveListingID] =
        useState(null);
